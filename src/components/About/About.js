...
const About = () => {
    return (
        <div className="mb-5 pb-5 mt-5 pt-5">
            <h2 className="text-center text-danger border border-info pb-2 rounded-pill" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="500">About</h2>
            <div className="text-center" data-aos="zoom-in-up" data-aos-duration="2000" data-aos-easing="ease-in-sine">
                <img className="w-50" src={About1} alt="" />
            </div>
            <div className="row  text-success">
                <div className="col-md-6 col-12 p-2  project-detail-card"  data-aos="fade-right" data-aos-offset="300" data-aos-duration="1000" data-aos-easing="ease-in-sine">
                ...
                <div className="col-md-6 col-12 p-2  project-detail-card"  data-aos="fade-left" data-aos-offset="300" data-aos-duration="1000" data-aos-easing="ease-in-sine">
            ...
            <div className="text-danger pt-5 mt-5">
                <h2 className="p-2 mb-2 text-center border rounded-pill border-info"  data-aos="fade-down" data-aos-easing="linear" data-aos-duration="500">Skills</h2>
